...
/// btStridingMeshInterface interface. Simply create this shape by passing the
/// btStridingMeshInterface to the constructor btGImpactMeshShapePart, then you
/// must call updateBound() after creating the mesh. When making operations with
/// this shape, you must call <b>lock</b> before accessing to the trimesh
/// primitives, and then call <b>unlock</b>. You can handle deformable meshes
/// with this shape, by calling postUpdate() every time when changing the mesh
/// vertices.
