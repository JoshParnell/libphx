...
/// the static concave btBvhTriangleMeshShape. It has an (optional) dynamic
/// aabb tree to accelerate early rejection tests. Currently, removal of child
/// shapes is only supported when disabling the aabb tree (pass 'false' in the
/// constructor of btCompoundShape)
...
protected:
	...
	/// increment m_updateRevision when adding/removing/replacing child shapes,
	/// so that some caches can be updated
